...
export class Backend implements backendInterface {
    ...
    async getProfile(arg0: SessionToken): Promise<{
        username: string;
        role: string;
    } | null> {
        if (this.processError) {
    ...
    async getTopTools(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopTools();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isAdmin(arg0: SessionToken): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async listUsers(arg0: SessionToken): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async recordUsage(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async register(arg0: string, arg1: string): Promise<string> {
        if (this.processError) {
            try {
